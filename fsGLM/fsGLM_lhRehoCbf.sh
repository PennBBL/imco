#----------------------------------#
# Lauren Beard | LH Reho-Cbf fsGLM #
#----------------------------------#
...
homedir=/data/jux/BBL/projects/coupling/imcoScripts/surfCoupling/groupAnalysis/lhrehoCbf
...
for i in $(cat $homedir/designs/n831.coupling_coef_reho_cbf.fwhm15.fsaverage5.ageAtScanmean_sex_pcaslRelMeanRMSMotion_restRelMeanRMSMotion.fwhm15.fsaverage5/subjlist.txt);do
	...
	cp /data/jux/BBL/projects/coupling/couplingSurfaceMaps/rehoCbf/lh/surf/${bblid}_${datexscanid}_lh.coupling_coef_reho_cbf.fwhm15.fsaverage5 /home/lbeard/concatTest
done

mri_concat  ~/concatTest/*lh.coupling_coef_reho_cbf.fwhm15.fsaverage5 --o $homedir/$hemi.$meas.$template.n$n.mgh
