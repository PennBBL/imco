...
qsub -V -N coupling_$time -t 1 -cwd -o $logdir -e $logdir -q $queue $scripts/cbfAlffgrid.sh -s $sublist -f $fwhm -o
qsub -V -t 2-$nsub -cwd -hold_jid coupling_$time -o $logdir -e $logdir -q $queue $scripts/cbfAlffgrid.sh -s $sublist -f $fwhm -o
